...
class _AddActivityViewState extends ConsumerState<AddActivityView> {
  ...
  void addActivity() => ref.read(activityNotifierProvider.notifier).addActivity(
        context: context,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => activityState.state == EnumState.loading
                        ? {}
                        : showDatePicker(
                            context: context,
                            initialDate: date,
                  ...
                  TextFormField(
                    enabled:
                        activityState.state == EnumState.loading ? false : true,
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: activityState.state == EnumState.loading
                          ? const Loader()
                          : const Text(
                              'Save',
                              style: TextStyle(
