...
class _EditActivityViewState extends ConsumerState<EditActivityView> {
  ...
  void editActivity(Activity activity) =>
      ref.read(activityNotifierProvider.notifier).editActivity(
            context: context,
            activity: Activity(
              id: activity.id,
              uid: activity.uid,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: activityState.state == EnumState.loading
          ? const Loader()
          : activityState.state == EnumState.failure
              ? ErrorText(error: activityState.message)
              : activityState.activity == null
                  ? const ErrorText(error: "Error occurred while fetching data")
                  : Builder(
                      builder: (context) {
                        final data = activityState.activity!;
